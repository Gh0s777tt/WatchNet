...
function getRiskLabel(score: number): string {
  if (score >= 8) return 'KRİTİK';
  if (score >= 6) return 'YÜKSEK';
  if (score >= 4) return 'YÜKSELMİŞ';
  return 'DÜŞÜK';
}
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="hud-text text-[12px] text-[var(--text-primary)]">SİNYAL İSTİHBARAT AKIŞI</span>
