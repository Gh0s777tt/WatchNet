        ...
        <div className="glass-panel osiris-glow overflow-hidden h-full flex flex-col" style={{ borderColor: 'rgba(57, 255, 20, 0.3)' }}>
          ...
          <div className="flex items-center justify-between px-3 md:px-4 py-2 md:py-3 border-b border-[var(--border-secondary)] bg-black/40">
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              {streamType === 'jpg' && (
                <button onClick={() => setRefreshKey(k => k + 1)} className="p-1.5 rounded hover:bg-[var(--hover-accent)] transition-colors" title="Akışı yenile">
            ...
            {loading && !error && !externalOnly && (
              <div className="absolute inset-0 flex items-center justify-center bg-black/80 z-10">
                <div className="text-center">
                  ...
                  <span className="text-[8px] font-mono text-[#39FF14] tracking-widest">AKIŞA BAĞLANILIYOR...</span>
                </div>
              </div>
            )}
            ...
            {externalOnly ? (
              <div className="absolute inset-0 flex items-center justify-center bg-black/90">
                <div className="text-center px-6">
                  ...
                  <span className="text-[9px] font-mono text-[#39FF14] tracking-widest block mb-1">HARİCİ AKIŞ</span>
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/90">
                <div className="text-center">
                  ...
                  <span className="text-[9px] font-mono text-red-400 tracking-widest block mb-1">AKIŞ KULLANILAMIYOR</span>
