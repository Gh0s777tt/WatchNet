...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  conflicts: {
    ...
    source: 'WatchNet conflict-zone registry, UCDP/ACLED conflict context, and documented boundary metadata such as the Korean DMZ.',
  ...
  ciiChoropleth: {
    ...
    source: 'WatchNet CII scoring service using conflict, unrest, advisories, cyber, AIS, aviation, natural-event, and news signals.',
  ...
  ais: {
    ...
    source: 'AISStream relay snapshots, WatchNet maritime service, and chokepoint disruption classifiers.',
  ...
  waterways: {
    ...
    source: 'WatchNet strategic-waterways registry with supply-chain chokepoint status overlays from AIS, NGA warnings, and PortWatch-derived feeds.',
  ...
  tradeRoutes: {
    ...
    source: 'WatchNet trade-route registry plus supply-chain chokepoint status and transit summaries.',
  ...
  hotspots: {
    ...
    source: 'WatchNet hotspot registry, RSS/GDELT news intelligence, hotspot escalation scoring, military activity, and CII context.',
