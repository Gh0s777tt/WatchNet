    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
          ...
          <span class="logo">WATCHNET</span><span class="logo-mobile">WatchNet</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://x.com/eliehabib" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@eliehabib</span>
          </a>
          <a href="https://github.com/Gh0s777tt/watchnet" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
      ...
      <nav class="mobile-menu" id="mobileMenu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">WATCHNET</span>
      ...
      <footer class="site-footer">
        <div class="site-footer-brand">
          ...
          <div class="site-footer-brand-text">
            <span class="site-footer-name">WATCHNET</span>
        ...
        <nav>
          ...
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : 'https://www.worldmonitor.app/docs'}" target="_blank" rel="noopener">Docs</a>
          <a href="https://status.worldmonitor.app/" target="_blank" rel="noopener">Status</a>
          <a href="https://github.com/Gh0s777tt/watchnet" target="_blank" rel="noopener">GitHub</a>
        ...
        <span class="site-footer-copy">&copy; ${new Date().getFullYear()} WatchNet &middot; based on <a href="https://github.com/koala73/worldmonitor" target="_blank" rel="noopener" class="site-footer-credit">World Monitor</a></span>
      </footer>
